...
function sortInterviewsByNewest(interviews: Interview[]): Interview[] {
...
export async function getLatestInterviews(
    ...
    return sortInterviewsByNewest(
        results.filter((interview) => interview.userId !== userId)
    ).slice(0, limit);
}
...
export async function getInterviewsByUserId(
    ...
    return sortInterviewsByNewest(results);
}
